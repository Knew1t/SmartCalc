...
dumbcalc::dumbcalc(QWidget *parent)
  ...
  // создаем кнопки со специальным текстом и выдаем им по слоту
  ...
  // Располагаем кнопки в пространстве
...
void dumbcalc::unaryOperatorClicked()
{
    Button *clickedButton = qobject_cast<Button *>(sender());
...
Button *dumbcalc::createButton(const QString &text, const char *member)
{
